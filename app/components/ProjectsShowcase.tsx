  ...
  const miniProjects = [
    {
      ...
      url: "https://vikasbabu780todo.netlify.app",
    },
    {
      name: "Guessing Game",
      tools: "HTML, CSS, JS",
      url: "https://guess-game-phi-five.vercel.app/",
    },
    {
      name: "BMI Calculator",
      tools: "HTML, CSS, JS",
      url: "https://body-mass-index-seven.vercel.app/",
    },
              ...
              <div className="bg-zinc-950 rounded-[1.8rem] p-8 h-full">
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {project.tech.map((t) => (
                    <span
                      key={t}
                      className="text-[10px] uppercase tracking-widest font-bold px-3 py-1 bg-white/5 border border-white/10 rounded-full text-gray-300"
                    >
                      {t}
                    </span>
                  ))}
            ...
            {miniProjects.map((mini, i) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <Zap
                    size={16}
                    className="text-yellow-500 group-hover:scale-125 transition-transform"
                  />
                  {mini.url && (
                    <ExternalLink
                      size={14}
