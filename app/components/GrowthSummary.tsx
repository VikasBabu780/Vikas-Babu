...
import { Rocket, Target, Code, Flame } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div className="p-6 rounded-2xl bg-zinc-900/50 border-l-4 border-orange-500">
                ...
                <p className="text-gray-400 text-sm">
                  Solving <span className="text-white font-bold">250+ problems</span> while maintaining continuous activity. This reflects my discipline in algorithmic thinking and daily habit of coding.
                </p>
              </div>
          ...
          >
            ...
            <div className="relative border-l border-zinc-800 ml-4 space-y-12">
              ...
              <div className="relative pl-8">
                <div className="absolute -left-2.25 top-1 w-4 h-4 rounded-full bg-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
              ...
              {/* Future Goal 2 */}
              <div className="relative pl-8">
                <div className="absolute -left-2.25 top-1 w-4 h-4 rounded-full bg-purple-500" />
              ...
              {/* Future Goal 3 */}
              <div className="relative pl-8">
                <div className="absolute -left-2.25 top-1 w-4 h-4 rounded-full bg-emerald-500" />
